<template>
  <div class="p-4">
    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="mb-4">
        <label class="block text-sm font-medium mb-1" for="document_status">{{ __('Document Status') }}</label>
        <input id="document_status" v-model="formData.document_status" type="text" class="border p-2 w-full rounded" readonly />
      </div>
